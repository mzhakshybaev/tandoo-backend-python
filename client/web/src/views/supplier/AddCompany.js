        ...
        <Col md="9">
          <Card>
            <CardBody className="p-4 text-center">
              ...
              <Button onClick={() => this.props.history.push('/home')}>{t('На главную')}</Button>
            </CardBody>
          </Card>
        </Col>
      </Row>
            ...
            <Row>
              ...
              <Col md={colLength2} className="mt-5">
                ...
                <Col sm={12} md={12}>
                  ...
                  {/*<Row>
                    <Col md={6}>
                      <FGI l={"Наличие задолженностей по налогам"} lf={7} ls={5}>
                        <ImageInput fileHandler={file => this.handleFiles("taxDebtImage", "taxDebtPreview", file)}
                                    comment={"Загрузить справку"}
                                    imgPreview={this.state.taxDebtPreview}/>
                      </FGI>
                    </Col>
                    <Col md={3}>
                      <Input type={"text"} value={this.state.taxDebtNumber} placeholder={"Номер справки"}
                    ...
                    <Col md={3}>
                      ...
                      <FormText color={"muted"}>Дата выдачи</FormText>
                    </Col>
                  </Row>
                  <Row>
                    <Col md={6}>
                      <FGI l={"Наличие задолженностей по социальным страховым выплатам"} lf={7} ls={5}>
                    ...
                    <Col md={3}>
                      <Input type={"text"} value={this.state.socDebtNumber} placeholder={"Номер справки"}
              ...
              <Col xs={12}>
                <Button onClick={() => this.save()} title={!this.canSendForm() ? t('Не все поля были заполнены!!!') : ''}>
                  {t('Отправить')}
                </Button>
              </Col>
